...
const NEXT_STATUS: Record<OrderStatus, OrderStatus | null> = {
  PENDING: "CONFIRMED",
  CONFIRMED: null, // L'agriculteur ne peut pas directement marquer comme DELIVERED
  DELIVERED: null,
  CANCELLED: null,
};
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-1 mt-2">
                          {order.items.map((item) => (
                            <span
                              key={item.id}
                              className="text-xs bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-400 px-2 py-0.5 rounded-full"
                            >
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        >
                          <motion.div
                            animate={{
                              rotate: selectedId === order.id ? 180 : 0,
                            }}
                          >
